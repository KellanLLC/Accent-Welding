/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=../wrangler.jsonc --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 40b9ddefa884489b506f1bc6e628ece2)
...
interface __BaseEnv_CloudflareEnv {
	...
	SPAM_WEBHOOK_URL: string;
	SWEEPER: DurableObjectNamespace /* Sweeper */;
	WORKER_SELF_REFERENCE: Fetcher /* accent-welding */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "COMPANY_NAME" | "ADMIN_PASSWORD" | "SESSION_SECRET" | "GHL_WEBHOOK_URL" | "GEMINI_API_KEY" | "SPAM_WEBHOOK_URL">> {}
}
